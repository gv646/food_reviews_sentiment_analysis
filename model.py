...
print(predict('The Magic behind that massal I found is nothing but Artificial Food colour. Dear ITC , please provide Natural and safe food to your beloved Indians. Even though the food colouring is approved but try to avoid such artificial food even in small traces and make the young Indian more stronger.'))